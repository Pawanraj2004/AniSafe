...
export function EcosimLandingPage() {
      ...
      <header className="bg-green-700 text-white p-4 sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            <Link href="#eyes-on-earth" className="hover:underline flex items-center">
            ...
            <Link href="#climate-time-machine" className="hover:underline flex items-center">
  ...
  <p className="text-xl mb-8">
    Explore Earth's ecosystems and climate through interactive simulations and data visualizations
  </p>
  ...
  <ChevronDown className="animate-bounce mt-8 mx-auto" size={32} />
        ...
        <section id="eyes-on-earth" className="mb-16">
          <h2 className="text-3xl font-bold mb-4">NASA's Eyes on Earth</h2>
          <Card>
            <CardHeader>
              <CardTitle>Explore Earth from Space</CardTitle>
              <CardDescription>Visualize NASA's Earth science satellite data in 3D</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <section id="quiz" className="mb-16">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Take our quiz to learn more about Earth's ecosystems and climate</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <section id="interactive-map" className="mb-16">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Interact with layers of climate and ecosystem data</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="aspect-video bg-gray-200 flex items-center justify-center rounded-lg overflow-hidden">
                <Image
        ...
        <section id="information" className="mb-16">
          ...
          <Tabs defaultValue="ecosystems">
            ...
            <TabsContent value="ecosystems">
              <Card>
                <CardHeader>
                  <CardTitle>Earth's Ecosystems</CardTitle>
                  <CardDescription>Learn about the diverse ecosystems on our planet</CardDescription>
                </CardHeader>
                <CardContent>
                  <p>Explore the intricate web of life in various biomes, from tropical rainforests to arctic tundras.</p>
                  <Image
            ...
            <TabsContent value="climate">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Understand the factors affecting Earth's climate</CardDescription>
                </CardHeader>
                <CardContent>
                  <p>Discover the complex interactions between the atmosphere, oceans, land, and ice that shape our climate.</p>
                  <Image
                    src="/placeholder.svg?height=200&width=400"
                    alt="Climate Factors"
                    width={400}
            ...
            <TabsContent value="conservation">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Learn about global initiatives to protect our planet</CardDescription>
                </CardHeader>
                <CardContent>
                  <p>Explore conservation strategies and success stories from around the world.</p>
                  <Image
                    src="/placeholder.svg?height=200&width=400"
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Experiment with the live IoT simulation embedded below:</CardDescription>
    </CardHeader>
    <CardContent>
      <iframe
